...
- [x] **独立 hzb-skills 仓库的 Dashboard 聚合** (commit: pending, date: 2026-07-12)
...
- [x] **Dashboard 分支查看 + public-source CI/CD** (commit: pending, date: 2026-07-12)
...
- [x] **本地完整 Dashboard** (commit: pending, date: 2026-07-12)
...
- [x] **Inventory 内容展开 + GitHub 原生编辑认证** (commit: pending, date: 2026-07-12)
...
- [x] **PowerShell 配置迁移闭环** (commit: pending, date: 2026-07-12)
...
- [x] **checkpoint slash prompt 适配器** (commit: pending, date: 2026-07-08)
...
- [x] **web-access skill 兼容 Codex 路径解析** (commit: pending, date: 2026-07-07)
...
- [x] **整理根 README 并纳入 web-access npm 依赖元数据** (commit: pending, date: 2026-07-01)
...
- [x] **karpathy-guidelines skill 在 Dashboard 可见** (commit: pending, date: 2026-06-16)
...
- [x] **statusline.ps1：jq-free PowerShell 状态栏** (date: 2026-06-14)
...
- [x] **settings.windows.json：Windows 专属配置** (date: 2026-06-14)
...
- [x] **install.ps1：Windows 安装器** (date: 2026-06-14)
...
- [x] **Dashboard 全局搜索：Ctrl+K 快捷键 + 下拉结果 + 分类导航** (commit: pending, date: 2026-03-30)
  ...
  - 实际效果：✅ 用户确认验证通过（2026-07-12）

- [x] **Memory 页面 Gist 集成 + export-memory.sh** (commit: pending, date: 2026-03-30)
  - 验证方法：
